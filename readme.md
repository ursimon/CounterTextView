...
```
dependencies {
        implementation 'com.github.ursimon.CounterTextView:library-rxjava1:1.0.2'
        implementation 'com.github.ursimon.CounterTextView:library-common:1.0.2'
}
```
...
```
dependencies {
        implementation 'com.github.ursimon.CounterTextView:library-rxjava2:1.0.2'
        implementation 'com.github.ursimon.CounterTextView:library-common:1.0.2'
}
```
